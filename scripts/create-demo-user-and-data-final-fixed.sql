...
BEGIN
    ...
    IF demo_user_id IS NOT NULL THEN
        ...
        -- Insert sample goals with goal_type column
        INSERT INTO goals (
            user_id, 
            title, 
            description, 
        ...
        (demo_user_id, 'Run 100 Miles This Month', 'Goal to run 100 miles in January', 'distance', 'running', 100, 45.5, 'miles', '2024-01-31'),
        (demo_user_id, 'Climb 5.10a Route', 'Work up to climbing a 5.10a route outdoors', 'skill', 'climbing', 1, 0, 'routes', '2024-03-01'),
        (demo_user_id, 'Hike 10 Peaks This Year', 'Challenge to summit 10 different peaks', 'count', 'hiking', 10, 3, 'peaks', '2024-12-31'),
        (demo_user_id, 'Snowboard 20 Days This Season', 'Get out on the mountain 20 times', 'frequency', 'snowboarding', 20, 8, 'days', '2024-04-01')
        ON CONFLICT DO NOTHING;
